...
namespace DistribuidoraAlimentos.BLL.Servicios
{
    public class DashBoardService :IDashBoardService
    {
        ...
        private readonly IGenericRepository<Productos> _productoRepositorio;
        private readonly IMapper _mapper;

        public DashBoardService(IVentaRepository ventaRepositorio, IGenericRepository<Productos> productoRepositorio, IMapper mapper)
        {
        ...
        private async Task<int> TotalProductos()
        {
            ...
            IQueryable<Productos> _productoQuery = await _productoRepositorio.Consultar();
