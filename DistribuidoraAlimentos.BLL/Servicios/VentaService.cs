...
namespace DistribuidoraAlimentos.BLL.Servicios
{
    public class VentaService : IVentaService
    {
        ...
        public async Task<VentasDTO> Registrar(VentasDTO modelo)
        {
            try
            {
        ...
        public async Task<List<ReportesVentaDTO>> Reporte(string fechaInicio, string fechaFin)
        {
            ...
            return _mapper.Map<List<ReportesVentaDTO>>(ListaResultado);
        }
    }
}
